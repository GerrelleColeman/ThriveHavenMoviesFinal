    ...
    public class AppDbContext : IdentityDbContext<Users, IdentityRole<Guid>, Guid>  
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Concession>().HasData(
              ...
              new Concession { ItemID = 1, ItemName = "Popcorn", Cost = 4.0, ImageUrl = "/Images/Concessions/Popcorn.jpg" },
              new Concession { ItemID = 2, ItemName = "Fountain Drink", Cost = 5.0, ImageUrl = "/Images/Concessions/drink.jpg" },
              new Concession { ItemID = 3, ItemName = "Hotdog", Cost = 5.0, ImageUrl = "/Images/Concessions/hotdog.jpg" }

               );//Add this to Concession Table
            ...
            new Movie { MovieID = 19, Name = "West side Story", Genre = "Musical/Romance", Year = "2021", TimeFrame = "2h 36m", Rating = "PG-13", ImageUrl = "/Images/MovieList/West Side Story.jpg" }
                ...
                );//Add this to Movie Table



        }//End of OnModelCreating to pass data to the data base
